...
/**
 * 테스트 URL
 * http://localhost:8080/spring-study-03-mvc-11-excel-pdf-view/reservationSummary.xls?date=2009-01-14
 * http://localhost:8080/spring-study-03-mvc-11-excel-pdf-view/reservationSummary.pdf?date=2009-01-14
 */
@Controller
